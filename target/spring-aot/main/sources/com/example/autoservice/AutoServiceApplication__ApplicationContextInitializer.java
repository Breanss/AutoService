 ...
 */
public class AutoServiceApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new AutoServiceApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new AutoServiceApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
